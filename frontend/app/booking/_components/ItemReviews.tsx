      ...
      <div className="relative z-10 flex flex-col h-full p-4">
        ...
        <div className="mb-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h2 className="text-sm font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent">
              Customer Reviews
            </h2>
          </div>
          ...
          <div className="mb-4">
            {!showForm ? (
              ...
              <form
                ...
                className="p-3 rounded-xl bg-white/70 border border-emerald-200/50 space-y-3"
              >
                <div>
            ...
            reviews.map((review, idx) => (
              ...
              >
                <div className="flex items-start gap-2.5">
                  {/* Avatar */}
                  <div
                    className={`flex-shrink-0 w-8 h-8 rounded-full bg-gradient-to-br ${getAvatarGradient(
                      review.username
