        ...
        {!imageError ? (
          ...
          <div className="h-full w-full flex items-center justify-center bg-gradient-to-br from-blue-100 to-indigo-100">
            <div className="text-center p-6 max-w-md">
              <svg className="w-20 h-20 text-blue-300 mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
              </svg>
              <p className="text-sm font-medium text-gray-700 mb-2">Erro ao carregar imagem</p>
              ...
              <details className="text-left">
                <summary className="text-xs text-blue-600 cursor-pointer hover:text-blue-800">Ver URL</summary>
                <p className="text-xs text-gray-600 mt-2 break-all bg-white p-2 rounded border">{selectedImage}</p>
              </details>
            </div>
          </div>
        )}
