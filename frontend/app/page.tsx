...
export default function Home() {
  ...
  if (isLoading || isAuthenticated) {
    return (
      <div className="h-full w-full flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-slate-900 dark:to-slate-800">
        <div className="text-center flex flex-col items-center gap-4">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600 flex-shrink-0"></div>
          <p className="mt-4 text-gray-600 dark:text-gray-400 h-6">
            Loading...
          </p>
        </div>
      </div>
  ...
  return (
    <div className="relative h-full w-full overflow-hidden">
      {/* Animated Background */}
      <div className="absolute inset-0 bg-linear-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-slate-900 dark:to-indigo-950" />

      {/* Animated Gradient Orbs */}
      <div className="absolute top-1/4 -left-20 w-96 h-96 bg-blue-400/30 rounded-full blur-3xl animate-pulse" />
      <div
        className="absolute bottom-1/4 -right-20 w-96 h-96 bg-indigo-400/30 rounded-full blur-3xl animate-pulse"
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center px-6">
        ...
        <p className="text-xl sm:text-2xl text-gray-600 dark:text-gray-300 text-center max-w-2xl mb-12">
          Rent premium fishing gear from local owners. Start your fishing
          adventure today!
        </p>
